...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * | Ctrl | GUI  | Alt  | CWord|Lower |    Space    |Raise | Left | Down |  Up  |Right |
    * `-----------------------------------------------------------------------------------'
    */
    [_ONE] =  LAYOUT_ortho_5x12 (
        ...
        KC_LCTL, KC_LGUI, KC_LALT, CW_TOGG, MO(1),   KC_SPC,  KC_SPC,  MO(2),  KC_LEFT,  KC_DOWN, KC_UP,   KC_RGHT
    ),
    ...
    */
    [_TWO] = LAYOUT_ortho_5x12 (
        ...
        _______, _______, _______, KC_APP,  _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
        ),
    ...
    */
    [_THREE] = LAYOUT_ortho_5x12 (
        ...
        _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_PGUP, KC_PGDN, KC_HOME, KC_END, _______,
        _______, _______, _______, KC_APP,  MO(3),   _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
        ),
